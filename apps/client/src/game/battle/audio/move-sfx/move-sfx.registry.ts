...
const SIGNATURE_BASE_ARCHETYPE: Readonly<Record<BattleMoveVfxSignaturePresetId, BattleMoveSfxArchetypeId>> = {
  ...
  "stone-edge": "ground",
  "shadow-force": "melee",
  "water-gun-retro": "stream",
  "razor-leaf-retro": "multi-projectile",
  "absorb-retro": "tether",
  "giga-drain-retro": "tether",
  "flame-wheel-retro": "contact",
  "quick-attack-retro": "contact",
  "scary-face-retro": "status",
  "rage-retro": "contact",
  "vine-whip-retro": "melee",
  "bubble-retro": "multi-projectile",
  "dragon-rage-retro": "beam",
  "thunder-shock-retro": "beam",
  "cut-retro": "melee",
  "fly-retro": "contact",
  "surf-retro": "wave",
  "strength-retro": "contact",
  "waterfall-retro": "contact",
  "rock-smash-retro": "melee",
  "whirlpool-retro": "aoe",
  "rock-climb-retro": "contact",
  "defog-retro": "status",
};
